...
CAMLprim value caml_glClearColor(value vr, value vg, value vb, value va) {
...
CAMLprim value caml_glViewport(value vX, value vY, value vWidth,
                               value vHeight) {
  int x = Int_val(vX);
  int y = Int_val(vY);
...
CAMLprim value caml_glClearDepth(value vd) {
...
CAMLprim value caml_glEnable(value vEnableOptions) {
  glEnable(variantToEnableOption(vEnableOptions));
  return Val_unit;
}

CAMLprim value caml_glDisable(value vEnableOptions) {
  glDisable(variantToEnableOption(vEnableOptions));
  return Val_unit;
}

CAMLprim value caml_glScissor(value vX, value vY, value vWidth, value vHeight) {
  int x = Int_val(vX);
  int y = Int_val(vY);
  int width = Int_val(vWidth);
  int height = Int_val(vHeight);
...
CAMLprim value caml_glDepthFunc(value vDepthFunc) {
  glDepthFunc(GL_LEQUAL);
  return Val_unit;
}

CAMLprim value caml_glBlendFunc(value vSrcFunc, value vDestFunc) {
  glBlendFunc(variantToBlendFunc(vSrcFunc), variantToBlendFunc(vDestFunc));
  return Val_unit;
}

CAMLprim value caml_glCreateShader(value v) {
  int shaderType;
  switch (Int_val(v)) {
  case 0:
...
CAMLprim value caml_glShaderSource(value vShader, value vSource) {
...
CAMLprim value caml_glCompileShader(value vShader) {
  CAMLparam1(vShader);
  GLuint shader = (GLuint)vShader;
...
CAMLprim value caml_glDeleteShader(value vShader) {
  GLuint shader = (GLuint)vShader;
  glDeleteShader(shader);
  return Val_unit;
}

CAMLprim value caml_glCreateProgram(value unit) {
  unsigned int shaderProgram;
  shaderProgram = glCreateProgram();
  return (value)shaderProgram;
}

CAMLprim value caml_glAttachShader(value vProgram, value vShader) {
...
CAMLprim value caml_glLinkProgram(value vProgram) {
  CAMLparam1(vProgram);
  unsigned int shaderProgram = (unsigned int)vProgram;
...
CAMLprim value caml_glGetAttribLocation(value vProgram, value vAttributeName) {
  unsigned int shaderProgram = (unsigned int)vProgram;
  const char *s;
...
CAMLprim value caml_glGetUniformLocation(value vProgram, value vUniformName) {
  unsigned int shaderProgram = (unsigned int)vProgram;
  const char *s;
...
CAMLprim value caml_glUniform1f(value vUniformLocation, double f) {
...
CAMLprim value caml_glUniform1f_byte(value vUniformLocation, value v0) {
  return caml_glUniform1f(vUniformLocation, Double_val(v0));
}

CAMLprim value caml_glUniform2f(value vUniformLocation, double f0, double f1) {
  int iUniformLocation = (int)vUniformLocation;
...
CAMLprim value caml_glUniform2f_byte(value vUniformLocation, value v0,
                                     value v1) {
  return caml_glUniform2f(vUniformLocation, Double_val(v0), Double_val(v1));
}

CAMLprim value caml_glUniform3f(value vUniformLocation, double f0, double f1,
                                double f2) {
  int iUniformLocation = (int)vUniformLocation;
...
CAMLprim value caml_glUniform3f_byte(value vUniformLocation, value v0, value v1,
                                     value v2) {
  return caml_glUniform3f(vUniformLocation, Double_val(v0), Double_val(v1),
                          Double_val(v2));
}

CAMLprim value caml_glUniform4f(value vUniformLocation, double f0, double f1,
                                double f2, double f3) {
  int iUniformLocation = (int)vUniformLocation;
...
CAMLprim value caml_glUniform4f_byte(value vUniformLocation, value v0, value v1,
                                     value v2, value v3) {
  return caml_glUniform4f(vUniformLocation, Double_val(v0), Double_val(v1),
                          Double_val(v2), Double_val(v3));
}

CAMLprim value caml_glUniform1i(value vUniformLocation, value v0) {
  int i0 = Int_val(v0);
  int iUniformLocation = (int)vUniformLocation;
...
CAMLprim value caml_glUniform2i(value vUniformLocation, value v0, value v1) {
  int i0 = Int_val(v0);
  int i1 = Int_val(v1);
  int iUniformLocation = (int)vUniformLocation;
...
CAMLprim value caml_glUniform3i(value vUniformLocation, value v0, value v1,
                                value v2) {
  int i0 = Int_val(v0);
  int i1 = Int_val(v1);
  int i2 = Int_val(v2);
...
CAMLprim value caml_glUniform4i(value vUniformLocation, value v0, value v1,
                                value v2, value v3) {
  int i0 = Int_val(v0);
  int i1 = Int_val(v1);
  int i2 = Int_val(v2);
...
CAMLprim value caml_glUniform2fv(value vUniformLocation, value vVec2) {
...
CAMLprim value caml_glUniform3fv(value vUniformLocation, value vVec3) {
...
CAMLprim value caml_glUniform4fv(value vUniformLocation, value vVec4) {
...
CAMLprim value caml_glUniformMatrix4fv(value vUniformLocation, value vMat4) {
...
CAMLprim value caml_glPixelStorei(value vPixelAlignmentParameter,
                                  value vParam) {
  glPixelStorei(variantToPixelAlignmentParameter(vPixelAlignmentParameter),
                Int_val(vParam));
  return Val_unit;
}

CAMLprim value caml_glCreateTexture(value vUnit) {
  unsigned int texture;
  glGenTextures(1, &texture);
  return (value)texture;
}

CAMLprim value caml_glBindTexture(value vTextureType, value vTexture) {
  unsigned int texture = (unsigned int)vTexture;
  glBindTexture(variantToTextureType(vTextureType), texture);
  return Val_unit;
}

CAMLprim value caml_glTexImage2D_native(value vTextureType, value vLevel,
                                        value vInternalFormat, value vFormat,
                                        value vType, value vPixels) {
  ...
  glTexImage2D(variantToTextureType(vTextureType), Int_val(vLevel), format,
               width, height, 0, variantToFormat(vFormat), variantToType(vType),
               pPixels);
...
CAMLprim value caml_glTexParameteri(value vTextureType, value vTextureParameter,
                                    value vTextureParameterValue) {
  glTexParameteri(variantToTextureType(vTextureType),
                  variantToTextureParameter(vTextureParameter),
                  variantToTextureParameterValue(vTextureParameterValue));
  return Val_unit;
}

CAMLprim value caml_glGenerateMipmap(value vTextureType) {
  glGenerateMipmap(variantToTextureType(vTextureType));
  return Val_unit;
}

CAMLprim value caml_glUseProgram(value vProgram) {
  unsigned int program = (unsigned int)vProgram;
  glUseProgram(program);
  return Val_unit;
}

CAMLprim value caml_glCreateBuffer(value unit) {
  unsigned int VBO;
  glGenBuffers(1, &VBO);
  return (value)VBO;
}

CAMLprim value caml_glBindBuffer(value vBufferType, value vBuffer) {
...
CAMLprim value caml_glBufferData(value vBufferType, value vData,
                                 value drawType) {
  ...
  if ((Caml_ba_array_val(vData)->flags & CAML_BA_UINT16) == CAML_BA_UINT16) {
    ...
    glBufferData(variantToBufferType(vBufferType),
                 size * sizeof(unsigned short), elements, GL_STATIC_DRAW);
  } else if ((Caml_ba_array_val(vData)->flags & CAML_BA_FLOAT32) ==
             CAML_BA_FLOAT32) {
    float *elements = (float *)Caml_ba_data_val(vData);
    glBufferData(variantToBufferType(vBufferType), size * sizeof(float),
...
CAMLprim value caml_glDrawArrays(value vDrawMode, value vFirst, value vCount) {
...
CAMLprim value caml_glDrawElements(value vDrawMode, value vCount, value vGlType,
                                   value vFirst) {
...
CAMLprim value caml_glEnableVertexAttribArray(value vIndex) {
  int index = (int)(vIndex);
  glEnableVertexAttribArray(index);
  return Val_unit;
}

CAMLprim value caml_glVertexAttribPointer(value vAttrib, value vNumComponents) {
  // TODO: Params!
  int attributeLocation = (int)(vAttrib);
  int numComponents = Int_val(vNumComponents);
  glVertexAttribPointer(attributeLocation, numComponents, GL_FLOAT, GL_FALSE, 0,
                        (void *)0);
  return Val_unit;
}

CAMLprim value caml_glUnbindBuffer(value unit) {
  printf("TODO: glUnbindBuffer\n");
  return Val_unit;
}

CAMLprim value caml_glReadPixels(value vX, value vY, value vFormat, value vType,
                                 value vPixels) {
