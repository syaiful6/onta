...
CAMLprim value caml_stb_image_load(value vPath, value vSuccess,
                                   value vFailure) {
...
CAMLprim value caml_stb_image_dimensions(value vImage) {
  CAMLparam1(vImage);
  CAMLlocal1(ret);
...
CAMLprim value caml_stb_image_from_color(value vR, value vG, value vB,
                                         value vA) {
